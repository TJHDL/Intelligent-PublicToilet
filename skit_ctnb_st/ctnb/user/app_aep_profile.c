...
int user_times=60;
GPIO_PinState state1=GPIO_PIN_RESET;
GPIO_PinState state2=GPIO_PIN_RESET;
GPIO_PinState state3=GPIO_PIN_RESET;
...
static void send_sensor_data(void)
{
  ...
  ret = send_msg(reportstr.str, reportstr.len, SEND_MODE_CON);
	...
	int8_t ret;
	humi_signal_up reportFlag;
	AepString      reportstr;
	getStatus(BSP_ALL, &BSP_status);
	//reportFlag.paper_signal = BSP_status.;
	
	//fill sensor data
	//reportFlag.paper_signal = NULL;
	reportFlag.humi_signal = BSP_status.hump;
	reportstr = codeDataReportByIdentifierToStr("humi_signal_up", &reportFlag);
	//reportstr = codeDataReportByIdentifierToStr("paper_signal_up", &reportFlag);
	app_log(reportstr.str);
...
static void send_temp_data(void)
{
	...
	//fill sensor data
	//reportFlag.paper_signal = NULL;
	reportFlag.temp_signal = BSP_status.temp;
	reportstr = codeDataReportByIdentifierToStr("temp_signal_up", &reportFlag);
	//reportstr = codeDataReportByIdentifierToStr("paper_signal_up", &reportFlag);
	app_log(reportstr.str);
...
static void send_hygi_data(void)
{
	int8_t ret;
	toilet_hygiene_signal_up reportFlag;
	AepString      reportstr;
	getStatus(BSP_ALL, &BSP_status);
	//reportFlag.paper_signal = BSP_status.;
	...
	if(user_times>=40)
	{
	  reportFlag.toilet_hygiene_signal[0] = 'S';
		reportFlag.toilet_hygiene_signal[1] = 'o';
		reportFlag.toilet_hygiene_signal[2] = 'B';
		reportFlag.toilet_hygiene_signal[3] = 'a';
		reportFlag.toilet_hygiene_signal[4] = 'd';
	}
	else if(user_times>=20)
	{
		reportFlag.toilet_hygiene_signal[0] = 'S';
		reportFlag.toilet_hygiene_signal[1] = 'o';
		reportFlag.toilet_hygiene_signal[2] = ',';
		reportFlag.toilet_hygiene_signal[3] = 's';
		reportFlag.toilet_hygiene_signal[4] = 'o';
	}
	else
	{
		reportFlag.toilet_hygiene_signal[0] = 'G';
		reportFlag.toilet_hygiene_signal[1] = 'o';
		reportFlag.toilet_hygiene_signal[2] = 'o';
		reportFlag.toilet_hygiene_signal[3] = 'd';
		reportFlag.toilet_hygiene_signal[4] = '!';
	}
	
	reportstr = codeDataReportByIdentifierToStr("toilet_hygiene_signal_up", &reportFlag);
	//reportstr = codeDataReportByIdentifierToStr("paper_signal_up", &reportFlag);
	app_log(reportstr.str);
...
static void send_paper_data(void)
{
	int8_t ret;
	paper_signal_up reportFlag;
	AepString      reportstr;
	getStatus(BSP_ALL, &BSP_status);
	//reportFlag.paper_signal = BSP_status.;
	...
	//fill sensor data
	//reportFlag.paper_signal = NULL;
	//if(PA0_input()==GPIO_PIN_SET)
	  reportFlag.paper_signal[0] = 'N';
	//else if(PA0_input()==GPIO_PIN_RESET)
		//reportFlag.paper_signal[0] = 'Y';
	reportstr = codeDataReportByIdentifierToStr("paper_signal_up", &reportFlag);
	//reportstr = codeDataReportByIdentifierToStr("paper_signal_up", &reportFlag);
	app_log(reportstr.str);
...
static void send_toilet1_data(void)
{
	int8_t ret;
	toilet_signal_up_1 reportFlag;
	AepString      reportstr;
	getStatus(BSP_ALL, &BSP_status);
	//reportFlag.paper_signal = BSP_status.;
	...
	//reportFlag.paper_signal = NULL;
	if(PA0_input()==GPIO_PIN_SET)
	  reportFlag.toilet_signal_1[0] = 'N';
	else if(PA0_input()==GPIO_PIN_RESET)
		reportFlag.toilet_signal_1[0] = 'Y';
	...
	reportstr = codeDataReportByIdentifierToStr("toilet_signal_up_1", &reportFlag);
	//reportstr = codeDataReportByIdentifierToStr("paper_signal_up", &reportFlag);
	app_log(reportstr.str);
...
static void send_toilet2_data(void)
{
	int8_t ret;
	toilet_signal_up_2 reportFlag;
	AepString      reportstr;
	getStatus(BSP_ALL, &BSP_status);
	//reportFlag.paper_signal = BSP_status.;
	...
	//fill sensor data
	//reportFlag.paper_signal = NULL;
	if(PB5_input()==GPIO_PIN_SET)
	  reportFlag.toilet_signal_2[0] = 'N';
	else if(PB5_input()==GPIO_PIN_RESET)
		reportFlag.toilet_signal_2[0] = 'Y';
	...
	reportstr = codeDataReportByIdentifierToStr("toilet_signal_up_2", &reportFlag);
	//reportstr = codeDataReportByIdentifierToStr("paper_signal_up", &reportFlag);
	app_log(reportstr.str);
...
static void send_toilet3_data(void)
{
	int8_t ret;
	toilet_signal_up_3 reportFlag;
	AepString      reportstr;
	getStatus(BSP_ALL, &BSP_status);
	//reportFlag.paper_signal = BSP_status.;
	...
	//fill sensor data
	//reportFlag.paper_signal = NULL;
	if(PB9_input()==GPIO_PIN_SET)
	  reportFlag.toilet_signal_3[0] = 'N';
	else if(PB9_input()==GPIO_PIN_RESET)
		reportFlag.toilet_signal_3[0] = 'Y';
	...
	reportstr = codeDataReportByIdentifierToStr("toilet_signal_up_3", &reportFlag);
	//reportstr = codeDataReportByIdentifierToStr("paper_signal_up", &reportFlag);
	app_log(reportstr.str);
...
void decode_aep_data(char *data)
{
	...
	if( result.code == AEP_CMD_SUCCESS )
	{
      ...
      ret = send_msg(rsp.str, rsp.len, SEND_MODE_CON);
		...
		else if( strcmp(result.serviceIdentifier, "door_control_1") == 0 )
		{
			AepString rsp;
		  uint8_t value;
			...
			if(value==1)
			  ...
			  PA1_output_value_HIGH();
			else
				//setStatus(LED0_DEVICE_ID,LED_BLUE);
			  PA1_output_value_LOW();
			
			//free(rsp.str);
		}
		else if( strcmp(result.serviceIdentifier, "clean_signal_down") == 0 )
		{
			AepString rsp;
		  uint8_t value;
		...
		else if( strcmp(result.serviceIdentifier, "water_control_down") == 0 )
		{
			AepString rsp;
		  uint8_t value;
			...
			if(value==1)
				//setStatus(LED0_DEVICE_ID,LED_RED);
			  PB8_output_value_HIGH();
			else
				//setStatus(LED0_DEVICE_ID,LED_BLUE);
			  PB8_output_value_LOW();
