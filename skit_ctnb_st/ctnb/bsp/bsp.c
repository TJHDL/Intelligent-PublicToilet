...
void PA1_output_value_HIGH(void)
{
	HAL_GPIO_WritePin(GPIOA, GPIO_PIN_1, GPIO_PIN_SET);
}

void PA1_output_value_LOW(void)
{
	HAL_GPIO_WritePin(GPIOA, GPIO_PIN_1, GPIO_PIN_RESET);
}

GPIO_PinState PA0_input(void)
{
  return HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_0);

}

GPIO_PinState PB5_input(void)
{
	return HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_5);
}

GPIO_PinState PB9_input(void)
{
	return HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_9);
}
void PB8_output_value_HIGH(void)
{
	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_8, GPIO_PIN_SET);
}

void PB8_output_value_LOW(void)
{
